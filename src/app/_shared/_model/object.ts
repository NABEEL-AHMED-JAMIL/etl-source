...
export interface IOrganization extends IBaseEntity {
    ...
    owner?: IAppUser;
    // EChartsOption
    SERVICE_SETTING_STATISTICS: EChartsOption;
    DASHBOARD_AND_REPORT_SETTING_STATISTICS: EChartsOption;
    FORM_SETTING_STATISTICS: EChartsOption;
    PROFILE_SETTING_STATISTICS: EChartsOption;
    SESSION_COUNT_STATISTICS: EChartsOption;
}
